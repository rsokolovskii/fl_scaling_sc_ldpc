...
void risultati(int sim, int n, int L, int W, double epsilon, double rate, int index)
{
    ...
    sprintf(stringa,"SC_LDPC_%d_%d_L%d_M%d_BP_SW%d_%dit_Random_BLER_%d.dat",Def_dv,Def_dc,Def_L,Def_M,W,MaxNumIt,index);
